*******************************************
Contributing to the Universal HTTP Client
*******************************************

.. note::

  As a general rule of thumb, the **Universal HTTP Client** applies
...
The **Universal HTTP Client** is meant to be a "beautiful" and "usable" library.
...
the **Universal HTTP Client** we rely on several tools:
...
#. Fork the `Git repository <https://github.com/insightindustry/universal-http-client>`_.
...
#. Install dependencies:
  ...
  .. code-block:: bash
    ...
    universal-http-client/ $ pip install -r requirements.txt
...
Check for open `issues <https://github.com/insightindustry/universal-http-client/issues>`_
...
.. seealso::
  ...
  For more information about the **Universal HTTP Client** testing approach please
  see: :doc:`Testing the Universal HTTP Client <testing>`
...
.. code-block:: bash
  ...
  universal-http-client/ $ cd docs
  universal-http-client/docs $ make html
...
.. code-block:: bash
  ...
  universal-http-client/docs/_build/html/index.html
